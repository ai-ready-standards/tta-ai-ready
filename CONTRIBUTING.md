...
본 저장소는 TTA 발주 사업의 공식 산출물 저장소입니다. 직접 푸시는 코어 팀(CODEOWNERS 참조)에 한정되며, 외부 기여는 GitHub Issue 및 Pull Request를 통해 제안할 수 있습니다.
...
| 시기 | Organization 소유 |
| --- | --- |
| 사업 진행 중 (2026.05~12) | 본 사업 수행사 |
| 사업 종료 후 (2027~) | 한국정보통신기술협회 (TTA) — GitHub Org 소유권 이관 |

- **편집 권한 3계층**: 코어 팀(쓰기 — CODEOWNERS 참조) · 일반 열람자(읽기) · 자동화 봇(CI 전용)
- **운영 이관 산출물**: D-9 운영 이관 패키지에 GitHub Org 권한 이양 절차 포함
...
- 본 저장소에는 **공개 가능한 산출물만** 커밋합니다. 인증 키, 발주처 미공개 자료, 비공개 회의록 등은 절대 커밋하지 마십시오.
