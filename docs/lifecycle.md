...
flowchart TB
    ...
    S8["⑨ 의견 검토 (동료 검토)<br/>━━━<br/>CODEOWNERS + TTA 주관 자문위원회"]
...
| 항목 | 내용 |
| --- | --- |
| 누가 | CODEOWNERS 자동 지정 + **TTA 주관 자문위원회** (내부 PG606·SPC·TC6 + 외부 학계·산업계·국제, 8~10인) |
| 무엇을 | 서면 검토 의견서 작성, 쟁점 사안은 자문위원회 회의 |
| 통과 기준 | CODEOWNERS Approval + 자문위원회 검토 의견 90% 이상 반영 |
| 자동/수동 | 반자동 (자동 reviewer 지정 + 자문위 정기 검토) |
| 사업 후 | 본 사업 종료 후 **TTA 상시 자문위원회**로 전환 (운영 이관) |
