...
Phase D-1 자기검증 (`pytest` + `pyshacl validate.py`) 실행 결과 발견된 6건의 버그를 수정. 본 패치 후 3개 예시 인스턴스가 모두 `Conforms: True`로 검증 통과. 보고서: `reports/phase_d1_verification.md`.
...
|---|---|---|---|
| Phase A | TTA-0976 elements.csv 추출 (93행) | `tta-standards/0976/` | 2026-05-03 |
| Phase A.5 | 누락 어휘 보강 (DataCite/re3data/DCMI Type/ISO + 통제어 117) | `inventory/`, `tta-standards/0976/enumerations.csv` | 2026-05-04 |
| Phase B | 매핑 매트릭스 작성 (93 + 117 = 210 mappings) | `mappings/` | 2026-05-04 |
| **Phase C** | **6 패키지 산출물 (본 1.0.0 릴리스)** | **`standards/P-01-research-data/`** | **2026-05-04** |

### Phase 별 산출 리포트

- `reports/prov-o_report.md` (Phase A: PROV-O 인벤토리)
- `reports/dcat-v3_report.md` (Phase A: DCAT v3)
- `reports/croissant_report.md` (Phase A: Croissant)
- `reports/schema-org_report.md` (Phase A: Schema.org)
- `reports/inventory_validation.md` (Phase A v1 + v2)
- `reports/phase_a5_summary.md` (Phase A.5)
- `tta-standards/0976/extraction_report.md` (Phase A: TTA 추출)
- `reports/tta-0976_mapping_conflicts.md` (Phase B: 충돌 분석)
- `reports/phase_b_summary.md` (Phase B 종합)
- `reports/phase_c_summary.md` (Phase C 종합 — 본 릴리스 완료 후 작성)
